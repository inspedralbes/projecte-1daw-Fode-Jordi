...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo '<p>Actuacio registrada correctament.</p>';
    echo '<a href="index.php" class="btn btn-secondary">Tornar</a>';
    echo '<a href="afegir_actuacio.php?id=' . $idIncidencia . '" class="btn btn-primary">Afegir una altra actuacio</a>';
}
?>
...
?>
    ...
    <form method="GET" action="afegir_actuacio.php">
        <div class="mb-3">
            <label for="id">Introdueix el codi de la teva incidència:</label>
            <br>
...
<?php
    ...
    if (!$incidencia) {
        ...
        echo '<a href="afegir_actuacio.php" class="btn btn-secondary">Tornar</a>';
    } else {
?>
    ...
    <form method="POST" action="afegir_actuacio.php">
        ...
        <div class="mb-3">
            <label for="temps">Temps invertit (minuts):</label>
            <br>
